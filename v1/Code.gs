...
const FIELDS = [
  ...
  },
  {
    slug: "query",
    name: "Query",
    description: "Query parameters like utm_campaign=henk&ref=duck&product=420",
    group: "VISITOR",
    type: "TEXT",
  },
  {
    ...
    name: "Path and query",
    description:
      "Path and query parameters like /contact?utm_campaign=henk&ref=duck&product=420",
    group: "VISITOR",
    type: "TEXT",
  },
  {
  ...
  },
  {
    ...
    name: "Referrer",
    description:
      "Full referrer of the page without protocol like twitter.com/search",
    group: "SOURCE",
    type: "TEXT",
  },
  {
    slug: "referrer_hostname",
    name: "Referrer hostname",
    description: "Referrer hostname like twitter.com",
    group: "SOURCE",
    type: "TEXT",
  },
  {
    slug: "referrer_path",
    name: "Referrer path",
    description: "Referrer path of the page like /search",
    group: "SOURCE",
    type: "TEXT",
  },
  {
  ...
  },
  {
    slug: "datapoint",
    name: "Datapoint name",
    description: "Pageview or event name",
    group: "META",
    type: "TEXT",
  },
  {
  ...
  },
  {
    ...
    description:
      "Original hostname (only useful when overwrite domain is used)",
    group: "URL",
    type: "TEXT",
  },
  {
  ...
  },
  {
    ...
    name: "User Agent",
    description:
      "User Agent of the device (OS and Browser values are more accurate)",
    group: "DEVICE",
    type: "TEXT",
  },
  {
